...
#ifndef _BLASTER_BITS_H
#define _BLASTER_BITS_H
#include "solvers/blaster/blaster_types.hpp"

namespace ismt
{
    const unsigned int BitsLen = 63;
    const Integer Bit2Data[] = {
        ...
        72057594037927936, 144115188075855872, 288230376151711744, 576460752303423488, 1152921504606846976, 2305843009213693952, 
